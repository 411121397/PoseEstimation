...
import threading
from Common import *
from Common import stop_exercise_event
...
def run_exercise(exercise_status):
        ...
        cv2.namedWindow('Standing Left Leg Front Lift', cv2.WND_PROP_FULLSCREEN)
        cv2.setWindowProperty('Standing Left Leg Front Lift', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
        ...
        countdown_complete = perform_countdown(
            ...
            window_name="Standing Left Leg Front Lift"
        )
        ...
        with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
            while cap.isOpened():
                ...
                if stop_exercise:  # Check if "Done" button was pressed
                    exercise_status["Standing Leg Front Lift"] = True
                    break
                ...
                cv2.imshow('Standing Left Leg Front Lift', image)
...
if __name__ == "__main__":
    exercise_status = {"Standing Leg Front Lift": False}
    run_exercise(exercise_status)
