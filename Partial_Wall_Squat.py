    ...
    def run_exercise(self):
        ...
        while self.cap.isOpened() and not self.stop_exercise_flag:
            ...
            self.mp_drawing.draw_landmarks(image, results.pose_landmarks, self.mp_pose.POSE_CONNECTIONS,
                                          ...
                                          self.mp_drawing.DrawingSpec(color=(44, 42, 196) if (stage in ['too_high', 'too_low']) else (
                                                   67, 196, 42),
            ...
            image = create_feedback_overlay(image, warning_message=warning_message,
                                            counter=max(0, int(hold_remaining)), reps=reps)
